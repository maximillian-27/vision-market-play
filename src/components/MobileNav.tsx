...
export function MobileNav() {
  ...
  return (
    <nav className="fixed bottom-px left-4 right-4 z-50 bg-background rounded-2xl border border-border shadow-lg h-[60px] min-h-[60px] max-h-[60px] overflow-hidden shrink-0 !transform-none !transition-none" style={{ height: '60px', flexShrink: 0 }}>
      <div className="flex items-stretch justify-around pt-2.5 pb-[env(safe-area-inset-bottom,6px)] -translate-y-1 h-full">
        {items.map((item) => {
