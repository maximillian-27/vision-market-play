...
export function MobileNav() {
  ...
  return (
    <nav className="fixed bottom-px left-4 right-4 z-50 bg-background rounded-2xl border border-border shadow-lg h-[60px] min-h-[60px] max-h-[60px] overflow-hidden">
