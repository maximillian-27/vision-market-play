...
export function MobileNav() {
  ...
  return (
    <nav className="fixed bottom-px left-4 right-4 z-50 bg-background rounded-2xl border border-border shadow-lg shrink-0 overflow-hidden" style={{ height: '60px', minHeight: '60px', maxHeight: '60px', boxSizing: 'border-box' }}>
