...
export function MobileNav() {
  ...
  return (
    <nav className="fixed bottom-px left-4 right-4 z-50 bg-background rounded-2xl border border-border shadow-lg" style={{ height: '64px' }}>
      <div className="flex items-stretch justify-around h-full -translate-y-1">
        {items.map((item) => {
