...
export function FeedFilters({ filters, onFiltersChange }: FeedFiltersProps) {
  ...
  return (
    <div className="space-y-3 sticky top-14 sm:top-12 z-10 bg-background/95 backdrop-blur-xl border-b border-border py-3 sm:py-1 -mx-4 px-4 sm:-mx-5 sm:px-5 lg:-mx-6 lg:px-6 mt-3 sm:mt-0">
      {/* Category Tabs row */}
        ...
        <div className="flex gap-1 overflow-x-auto pb-0.5 scrollbar-hide flex-1">
          {categories.map(({ label, icon: Icon }) => (
            <button
              ...
              className={`whitespace-nowrap font-medium px-3.5 py-1.5 sm:py-1 text-sm rounded-full transition-all flex items-center gap-1.5 ${
