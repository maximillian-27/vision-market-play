...
export function FeedFilters({ filters, onFiltersChange }: FeedFiltersProps) {
  ...
  return (
    <div className="space-y-3 sticky top-14 z-10 bg-background/95 backdrop-blur-xl border-b border-border pt-2 pb-3 -mx-4 px-4 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
