    ...
    <div className="flex flex-col p-4 pb-5 rounded-xl border border-primary/25 bg-gradient-to-br from-primary/[0.12] via-primary/[0.04] to-card h-full relative overflow-hidden shadow-sm shadow-primary/5">
      ...
      <div className="flex items-center justify-between mb-2 relative">
        <div className="flex items-center gap-2">
          <div className="flex items-center justify-center w-6 h-6 rounded-lg bg-amber-500/20 shadow-sm shadow-amber-500/10 ring-1 ring-amber-500/20">
            <Trophy className="h-3.5 w-3.5 text-amber-500" />
          </div>
          <span className="text-[10px] uppercase tracking-widest font-bold text-amber-500">Weekly Draw</span>
        </div>
      ...
      {/* Footer links */}
      <div className="flex items-center gap-3 pt-0.5 border-t border-border/20 mt-auto -mb-3">
        <Dialog>
