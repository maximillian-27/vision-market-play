...
const positions = [
  { id: 1, market: "Will Bitcoin reach $100k by 2025?", position: "Yes", tickets: 150, ticketPrice: 0.45, currentPrice: 0.62, pnl: 25.5, pnlPercent: 37.8 },
  { id: 2, market: "Fed rate cut in March 2025?", position: "No", tickets: 200, ticketPrice: 0.38, currentPrice: 0.41, pnl: 6, pnlPercent: 7.9 },
  { id: 3, market: "Tesla Q4 earnings beat?", position: "Yes", tickets: 100, ticketPrice: 0.55, currentPrice: 0.48, pnl: -7, pnlPercent: -12.7 },
  { id: 4, market: "NBA Championship - Lakers?", position: "Yes", tickets: 75, ticketPrice: 0.22, currentPrice: 0.28, pnl: 4.5, pnlPercent: 27.3 },
];
                    ...
                    <div className="sm:hidden">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-[11px] text-muted-foreground">{position.tickets} @ ${position.ticketPrice}</span>
                        </div>
                    ...
                    <div className="hidden sm:flex items-center justify-between">
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-3 text-sm text-muted-foreground">
                          ...
                          <span>{position.tickets} tickets @ ${position.ticketPrice}</span>
