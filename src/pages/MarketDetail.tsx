...
export default function MarketDetail() {
  ...
  return (
    <div className="min-h-screen bg-background pb-44 sm:pb-56">
        ...
        {!isAwaitingResolution && (
          <div className="px-4 py-4 space-y-3 sm:hidden border-t border-border/40">
            ...
            <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-[hsl(var(--pollgy-blue))]/5 border border-[hsl(var(--pollgy-blue))]/15">
              ...
              <span className="text-[11px] font-medium text-[hsl(var(--pollgy-blue))]">
      ...
      <div className="sm:hidden fixed bottom-14 left-0 right-0 bg-background/95 backdrop-blur-sm border-t border-border/40 z-30">
        <div className="max-w-2xl mx-auto px-3 pt-2.5 pb-[calc(env(safe-area-inset-bottom)+0.5rem)] space-y-2">
          {isAwaitingResolution ? (
            ...
            <>
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  {isSubmitting
                    ? "Buying..."
                    : selectedOutcome
                      ? `🎟️ Buy ${ticketCount} · $${totalCost.toFixed(2)}`
                      : "Pick a side"
                  }
                </Button>
              </div>
              ...
              <div className="flex items-center justify-center gap-2 text-[10px] text-muted-foreground">
                ...
                <span>·</span>
                <span className={estimatedProfit > 0 ? 'text-success font-medium' : ''}>
      ...
      {/* DESKTOP: Full sticky entry panel */}
      <div className="hidden sm:block fixed bottom-0 left-0 right-0 bg-background border-t border-border/40 z-30">
